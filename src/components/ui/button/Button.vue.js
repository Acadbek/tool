...
function __VLS_template() {
    ...
    __VLS_components.Primitive;
    // @ts-ignore
    [radix_vue_1.Primitive, radix_vue_1.Primitive,];
    // @ts-ignore
    ...
    __VLS_styleScopedClasses = ((0, utils_1.cn)((0, _1.buttonVariants)({ variant, size }), props.class));
    var __VLS_6 = {};
    // @ts-ignore
    [as, asChild, utils_1.cn, _1.buttonVariants, variant, size,];
    ...
    const __VLS_internalComponent = __VLS_defineComponent({
        setup() {
            return {
                Primitive: radix_vue_1.Primitive,

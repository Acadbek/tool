...
function __VLS_template() {
    ...
    ({}({ ...(__VLS_ctx.delegatedProps), ...{ class: ((__VLS_ctx.cn('-mx-1 my-1 h-px bg-muted', props.class))) }, }));
    __VLS_styleScopedClasses = ((0, utils_1.cn)('-mx-1 my-1 h-px bg-muted', props.class));
    // @ts-ignore
